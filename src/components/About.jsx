...
function About () {
    ...
    <h2>IronEscapes, find the perfect accomodation for your needs!  </h2>
    <p> IronEscapes is a platform that compiles the best accommodations, guaranteeing you an unforgettable trip. Scroll down and find your next spot! </p>
        </section>
    </header>
    <div >
        <h2>The team behind the project</h2>
            <section className= "teamContainer">
                ...
                <h3>Gwendal </h3>
                <p>Based in France, Gwendal started his carreer as consultant in the banking area, before switching to transport topics. As hobbies, he loves discovering new places while doing some exercise (running, biking...). Nothing better than a good headquarter to enjoy these activities... That's where IronEscapes comes up!</p>
